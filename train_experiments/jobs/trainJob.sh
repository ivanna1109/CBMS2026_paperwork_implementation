...
#SBATCH --output=/home/ivanam/CBMS_bioWork/train_experiments/output/train_%j.log
#SBATCH --error=/home/ivanam/CBMS_bioWork/train_experiments/output/train_%j.err
